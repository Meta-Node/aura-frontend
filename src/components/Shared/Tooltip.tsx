...
> = ({
  ...
  return (
    <div className={`relative inline-block ${className}`} {...rest}>
      ...
      <div
        className={`absolute z-10 whitespace-nowrap text-black bg-gray-200 dark:bg-gray-800 h-auto dark:text-white text-sm rounded px-2 py-1 shadow-lg transition-opacity duration-300 transform ${
          isVisible
